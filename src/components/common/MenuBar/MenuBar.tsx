...
export function NavigationMenuDemo() {
  return (
    <NavigationMenu className="px-14">
      <NavigationMenuList>
        <NavigationMenuItem>
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger>Lenovo</NavigationMenuTrigger>
          <NavigationMenuContent>
            <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[1200px]">
        ...
        <NavigationMenuItem>
          ...
          <NavigationMenuContent>
            <ul className="grid w-[800px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[1200px] ">
              {components.map((component) => (
                <ListItem
                  key={component.title}
                  title={component.title}
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger>Huawei</NavigationMenuTrigger>
          <NavigationMenuContent>
            <ul className="grid w-[800px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[1200px] ">
              {components.map((component) => (
                <ListItem
